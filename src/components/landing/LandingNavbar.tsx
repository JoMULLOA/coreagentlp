    ...
    <div className="sticky top-0 z-50 bg-black/90 backdrop-blur-xl border-b border-neutral-800/80">
      ...
      <header className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3 group">
          <div className="relative w-10 h-10 rounded-xl overflow-hidden bg-neutral-900 border border-neutral-700 shadow-md group-hover:scale-105 transition duration-200 flex items-center justify-center">
            <Image
          ...
          <div className="flex flex-col">
            <span className="font-extrabold text-xl tracking-tight text-white flex items-center gap-2">
              TENTACULUS <span className="text-[10px] font-mono font-bold bg-neutral-800 text-emerald-400 px-2 py-0.5 rounded border border-neutral-700">AI OPS</span>
            </span>
          </div>
        </Link>
